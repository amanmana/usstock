...
import { Heart, Users, Book, HelpCircle, LayoutDashboard, ClipboardCheck, TrendingUp, Settings, Star, Zap } from 'lucide-react';
...
const Footer = () => {
    ...
    const navLinks = [
        ...
        { to: '/btst', label: 'BTST 🚀', icon: <Zap className="w-3.5 h-3.5" />, color: 'indigo' },

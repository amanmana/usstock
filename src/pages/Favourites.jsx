    ...
    const favResults = uniqueTickers.map(ticker => {
        ...
        if (base) {
            return {
                ...
                ticker: ticker,
                market,
                short_name: base.short_name || details.short_name || '',
                company_name: base.company_name || details.company_name || base.company || '',
        ...
        return {
            ...
            company_name: details.company_name || 'Loading Data...',
